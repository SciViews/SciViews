...
It would have beeen nice to name our object `pca`. But that `pca` S3 object could not be compatible with **ade4**’s `pca` object. So, we decided to give it a different name: `pcomp`.
